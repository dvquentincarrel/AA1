 ...
 * attribut d'instance.
 * Aussi, toutes les méthodes sont statiques et la classe n'a pas vocation a
 * être instanciée.
 * <p>
...
public class CLI {
     ...
     */
    public static final Commande lireCommande() {
     ...
     */
    public static final String saisirNouvelInstrument(final Set<String> nomsConnus) {
     ...
     */
    public static final String choisirInstrument(final Set<String> nomsConnus) {
     ...
     */
    public static final String saisirNouvelEnfant(final Set<String> nomsConnus) {
     ...
     */
    public static final String choisirEnfant(final Set<String> nomsConnus) {
     ...
     */
    public static final Jour lireJour(final Set<Jour> joursOccupes) {
     ...
     */
    public static final void afficherInscriptionsInstruments(final Collection<Instrument> instruments) {
     ...
     */
    public static final void afficherInscriptionsEnfants(final Collection<Enfant> enfants) {
     ...
     *     sinon.
     */
    public static final void informerUtilisateur(final String msg, final boolean succes)
    {
